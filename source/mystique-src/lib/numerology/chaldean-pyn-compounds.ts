...
const COMPOUND_LIST: ChaldeanPYNCompound[] = [
  // ── PERSONAL YEAR 1: INITIATION ──────────────────────────────────────────
  {
    ...
    manifestationPatterns:
      "Individuals experiencing 10/1 often report synchronicities that feel almost theatrical in their precision — meeting exactly the right person at exactly the right moment, discovering precisely the needed resource just as a project requires it, encountering opportunities that seem tailor-made for their emerging direction. There is rarely mediocrity with 10/1: the period's outcomes tend toward extremes — great success or significant failure, rapid advancement or sudden reversal. The compound number's warning is clear: with great power comes great responsibility. The Turning Downward: the Wheel governs rise and fall according to its rotation, and the tradition never promised the rotation upward. Read 10 in a year of catastrophe as the wheel at its descending quarter — fortune leaving a place on schedule, without malice and without warning.",
  },
  {
    compound: 19,
    reduced: 1,
    ...
    manifestationPatterns:
      "This compound produces what practitioners have called 'effortless success' — not that no effort is required, but that the effort invested yields returns disproportionate to the input. Projects launched during 19/1 tend to gain momentum through what appears to be favorable coincidence. The individual's plans encounter support from unexpected quarters, obstacles dissolve before they become serious impediments, and the period's initiatives create foundations that continue yielding benefits long after this cycle concludes.\n\nThe 19/1 blessing extends to personal life as well as professional endeavors. Happiness and fulfillment characterize this cycle; the individual experiences a sense of being aligned with their purpose, of moving in harmony with the deeper currents of their destiny. Withheld Radiance: the Prince of Heaven is victorious over all temporal failure, but the tradition attaches that victory to the person or nation and never to the structures around them. When a 19 period coincides with a visitation the people did not choose — the earth moving, a fever travelling, the violence of others — the number reads as the light withheld rather than the light refused, and the triumph is deferred to what survived. Practitioners note that 19 gives personal fortune while offering no immunity from the common fate.",
  },
  {
    compound: 28,
    reduced: 1,
  ...
  },
  {
    ...
    manifestationPatterns:
      "This compound produces what practitioners have called 'partnership magic' — the phenomenon where the right person appears at precisely the moment their contribution becomes essential. Business partnerships formed during 37/1 tend to be mutually beneficial and enduring. Romantic connections initiated during this cycle carry unusual depth and transformative potential.\n\nThe period's creative and professional endeavors gain power through collaboration. The individual's ideas find receptive audiences; their initiatives attract capable co-creators; their ventures benefit from the resources and networks that partners provide. The 37/1 success formula is straightforward: seek alliance, welcome collaboration, and recognize that the period's initiating energy achieves its fullest expression through connection rather than isolation. The Peace Kept Indoors: the 8-pointed star gives peace, love and fortunate partnership; where partnership is refused or the land itself withholds, the peace of 37 is the peace of closed doors — the quiet of a place keeping its people alive by keeping them apart. It is fortunate still, and measured against what was lost outside.",
  },
  {
    compound: 46,
    reduced: 1,
  ...
  },
  {
    ...
    manifestationPatterns:
      "The 64/1 produces success in fields requiring both creativity and organization. The individual's initiating energy finds effective expression through projects that combine artistic vision with practical implementation. Partnerships thrive when they include clear division of creative and administrative responsibilities. The period's initiatives benefit from attention to both the functional and the aesthetic dimensions of every endeavor. Shadow in Authority: the innovator may be the one with the new order already written in his pocket. In a coup year 64 is the new broom and the new rules: the innovation is the government itself.",
  },
  {
    compound: 73,
    reduced: 1,
  ...
  },
  {
    ...
    manifestationPatterns:
      "The 20/2 frequently produces experiences that feel like 'wake-up calls' — events that disrupt comfortable routines, encounters that challenge established priorities, inner promptings that refuse to be silenced. The angel's trumpet is not a gentle suggestion; it is a summons that demands response. The individual may feel drawn to causes, movements, or purposes that have no connection to their previous plans.\n\nThe period's partnerships carry the quality of spiritual fellowship — connections formed around shared purpose, relationships that support mutual growth in service of larger goals. Delays and obstacles that arise are best understood as necessary preparation. The Trumpet: the Awakening is pictured as a trumpet sounded over sleepers who rise. Read 20 in years of flood, fever or earthquake as the awakening no one scheduled — a people roused out of ordinary life by what happened to them, and unable to return to the sleep they left.",
  },
  {
    compound: 29,
    reduced: 2,
  ...
  },
  {
    ...
    manifestationPatterns:
      "In a personal year, 30/3 may manifest as a book, paper, interview, performance, public explanation, examination, research discovery, teaching opportunity, creative plan, or strategic decision point. It may also bring a public success that does not feel emotionally complete, a choice between privacy and visibility, or a situation where the person’s words become more important than their actions.\n\nPredictively, watch for ambivalence around achievement: the person may receive proof that they can do something, but must still decide whether it is the thing they are meant to do. The strongest use of 30/3 is disciplined expression: finish the article, state the thesis, define the message, and do not let brilliance dissolve into endless contemplation. The weakest use is ironic detachment — seeing all roads so clearly that one refuses to walk any of them. Shadow at the Crossroads: achievement and disappointment stand together. A settlement reached under 30 is measured by the road not taken, and the number records the feeling of an arrangement that cost more than it gave.",
  },
  {
    compound: 39,
    reduced: 3,
  ...
  },
  {
    ...
    manifestationPatterns:
      "The 23/5 produces encounters with influential people who provide unexpected support. The individual may receive mentorship from established figures in their field, may be recommended for positions by powerful advocates, or may find that their initiatives gain approval and resources from those in positions to grant them.\n\nThe 23/5 period's success has a quality of inevitability about it. Obstacles that would block progress in other cycles dissolve when confronted with the Royal Star's influence. The individual experiences what feels like cosmic support — a sense that their endeavors are aligned with larger forces that ensure their success. The Star Withdrawn: the Royal Star promises help from superiors and protection from those in high places; where the high places look away — a massacre permitted, a storm unrelieved, a plague ignored — the same number measures precisely how far the protection failed to reach. Read 23 in such years as the ledger of patronage: who was shielded, and who was left outside the shield.",
  },
  {
    compound: 32,
    reduced: 5,
  ...
  },
  {
    ...
    manifestationPatterns:
      "The 33/6 produces opportunities for significant service and teaching. The individual's capacity for care and nurture finds expression through roles that guide, heal, or educate others. Their presence becomes a source of inspiration and transformation for those who encounter them. The period's partnerships and relationships carry qualities of spiritual fellowship — connections that support mutual growth in service of higher purposes. The Lesson by Force: the Master Teacher instructs whether or not the class consents. Where authority changes hands without consent, or a visitation teaches what nobody wished to learn, 33 is present not as the cause but as the instruction that follows — the new order, and the lesson a people must absorb.",
  },
  {
    compound: 42,
    reduced: 6,
    ...
    manifestationPatterns:
      "The 42/6 produces solid, enduring relationships built through patient effort. The individual's care for others is demonstrated through daily actions rather than occasional grand displays. Partnerships formed during this period tend to be characterized by mutual reliability and shared commitment to practical responsibilities. The period's service-oriented efforts yield results that accumulate slowly but prove durable over time. The Duty that Outlives the Man: steady and assured describes the machinery of care — the clinic, the school, the office that opens again in the morning. In a year of upheaval the same number appears as continuity: whoever is removed, the duty remains to be discharged by the next pair of hands.",
  },
  {
    compound: 51,
    reduced: 6,
  ...
  },
  {
    ...
    manifestationPatterns:
      "In a personal year, 60/6 may manifest as family duty, caretaking, marriage decisions, national or institutional service, public gratitude, retirement, electoral judgment, health-related dependency, home responsibility, or a role change inside a community that still loves the person. Churchill 1945 is the model: love and gratitude for wartime service were real, yet voters rejected him for the next chapter.\n\nPredictively, 60/6 asks the person to serve with boundaries and accept that affection is not the same as permanence. The highest form is graceful transition into a wiser mode of care. The lowest form is clinging to a role because one believes past service should purchase future obedience. Shadow in War: 60 tests love by boundary; in a civil war the same test appears as family divided against family — the number of those made to choose a side of their own blood.",
  },
  {
    compound: 69,
    reduced: 6,
  ...
  },
  {
    ...
    manifestationPatterns:
      "The 34/7 produces harmonious integration of inner and outer life. The individual's analytical and spiritual pursuits proceed alongside creative and professional endeavors, with each dimension supporting the others. The period's introspection yields insights that enhance practical performance; the period's practical achievements create resources that support spiritual exploration. The Balance Broken: good work and a good balance are the gifts of 34; in a year when authority is seized or a visitation arrives, the number records the loss of that balance — the ordinary arrangement of life suspended, the striver carrying more than the load he agreed to.",
  },
  {
    compound: 43,
    reduced: 7,
    ...
    manifestationPatterns:
      "The 43/7 produces experiences of fundamental disruption. The individual's plans and projects may fail completely; their spiritual practices may prove ineffective; their analytical frameworks may reveal fatal inconsistencies. The period's destructiveness is comprehensive, affecting multiple dimensions of life simultaneously.\n\nYet the Point of Reaper is not merely destructive; it is also cleansing. The 43/7 removes what is false, hollow, or unsustainable, creating the emptiness from which genuine understanding can emerge. The individual who surrenders to the period's dissolution rather than fighting it discovers that the destruction was necessary preparation for authentic reconstruction. Founded Out of Ash: destruction and annihilation is the letter of 43, so a nation founded under it is founded at the point of reaper — an independence that follows a catastrophe and cannot be understood apart from it. Read 43 in founding years as the ash out of which the state is raised.",
  },
  {
    compound: 52,
    reduced: 7,
    ...
    manifestationPatterns:
      "The 52/7 produces deep emotional insights that can be applied to healing others. The individual's own experiences of upheaval and transformation become the foundation for compassionate understanding of others' struggles. The period's destructiveness, properly processed, becomes the basis for wisdom that serves collective emotional healing. The Peacemakers' Ledger: caring and charitable people who want to bring emotional peace to others — under 52 the peace is won by ending something, and every treaty carries the cost of those it leaves outside. Read 52 in years of civil war as the number of the negotiators: the ones who stop the fighting and inherit the blame.",
  },
  {
    compound: 61,
    reduced: 7,
  ...
  // ── PERSONAL YEAR 8: POWER ───────────────────────────────────────────────
  {
    ...
    manifestationPatterns:
      "The 17/8 produces material achievement that carries spiritual significance. The individual's professional success, financial gains, and positions of authority are not merely secular accomplishments but expressions of higher purpose. Their leadership inspires others; their business practices embody ethical principles; their material wealth becomes a resource for serving collective welfare.\n\nThe compound number's single warning is important: 17 reduces to 8, and the 8's association with 4 creates potential vulnerability when the number is 'associated with the single number of fours and eights.' The period's spiritual power must be grounded in practical wisdom. Shadow in the Raid: immortality is the promise of 17; where force is used under it, the number speaks of the dead who are remembered and of a peace purchased by arms rather than received.",
  },
  {
    compound: 26,
    reduced: 8,
  ...
  },
  {
    ...
    manifestationPatterns:
      "The 53/8 produces partnership dangers in business and creative ventures that involve communication, media, and verbal exchange. The individual's material ambitions may lead them to form alliances in publishing, broadcasting, marketing, or other communication-related fields. The period's lesson remains consistent with the 26/8 warning: extreme caution in partnership and willingness to pursue goals independently. The Word as Instrument: neither fortunate nor unfortunate in itself, 53 measures the use of the word in business and in power. Where a strike is broken or a press is guided, the same number is present as the language of management — the sentence that ends an argument rather than winning it.",
  },
  {
    compound: 62,
    reduced: 8,
  ...
  },
  {
    ...
    manifestationPatterns:
      "The 36/9 produces creative achievement that gains authoritative recognition. The individual's artistic, communicative, or expressive efforts are acknowledged by those in positions to grant influence and opportunity. The period's completion theme operates through the fruition of creative projects that have been developing through previous cycles. Shadow in Completion: 36 finishes what others began; in a year of emergency the number reads as the quiet closing of doors and the last duties performed without ceremony.",
  },
  {
    compound: 45,
    reduced: 9,
